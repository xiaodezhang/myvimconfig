...
ruby << EOF
  # require Ruby files
  begin
  #使用session会出现错误，包含库路径没有成功包含进去，从测试来看，应该是windows下
  #的路径问题，事实上，linux下没有出现这个问题，我不懂ruby，几次修改也没有效果，
  #直接包含绝对路径解决了这个问题
  #    $LOAD_PATH << "C:/Users/zhang_xiaode/vimfiles/bundle/command-t/ruby/command-t/lib"
  #  $LOAD_PATH << "C:/Users/zhang_xiaode/vimfiles/bundle/command-t/ruby/command-t/ext"
    require 'command-t'
